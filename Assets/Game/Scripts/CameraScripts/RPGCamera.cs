...
public class RPGCamera : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        {
            if (StateManager.rightStickInputX != 0 || StateManager.rightStickInputY != 0)
            {
                xDeg += StateManager.rightStickInputX * xSpeed * 0.02f;
                yDeg -= StateManager.rightStickInputY * ySpeed * 0.02f;
            }

            // otherwise, ease behind the target if any of the directional keys are pressed
            else if (StateManager.leftStickInputX != 0 || StateManager.leftStickInputY != 0)
            {
